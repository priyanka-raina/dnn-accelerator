...
directive set -DESIGN_HIERARCHY {
    {PEArray<IDTYPE, ODTYPE, 1, 16, 16, 7, 7, 64>} 
...
directive set /PEArray<IDTYPE,ODTYPE,1,16,16,7,7,64>/ProcessingElement<IDTYPE,ODTYPE,1> -MAP_TO_MODULE {[CCORE] ProcessingElement<IDTYPE,ODTYPE,1>.v1}
...
go assembly
directive set /PEArray<IDTYPE,ODTYPE,1,16,16,7,7,64>/run -DESIGN_GOAL Latency
directive set /PEArray<IDTYPE,ODTYPE,1,16,16,7,7,64>/run -CLOCK_OVERHEAD 0.000000
...
directive set /PEArray<IDTYPE,ODTYPE,1,16,16,7,7,64>/run/in_tmp:rsc -MAP_TO_MODULE {[Register]}
directive set /PEArray<IDTYPE,ODTYPE,1,16,16,7,7,64>/run/out_tmp.value:rsc -MAP_TO_MODULE {[Register]}
directive set /PEArray<IDTYPE,ODTYPE,1,16,16,7,7,64>/run/w_tile.value:rsc -MAP_TO_MODULE {[Register]}
directive set /PEArray<IDTYPE,ODTYPE,1,16,16,7,7,64>/run/in_tmp2:rsc -MAP_TO_MODULE {[Register]}
directive set /PEArray<IDTYPE,ODTYPE,1,16,16,7,7,64>/run/out_tmp2.value:rsc -MAP_TO_MODULE {[Register]}
go architect
